            ...
            <div className='card-body'>
              <form >
                ...
                <div id="submit-button">
                  {
                    editFlag ? <button className='btn btn-warning' onClick={editSubmitHandler} type='submit'>Edit</button> : <button className='btn btn-info' onClick={addSubmitHandler} type='submit'>Add</button>
                  }
